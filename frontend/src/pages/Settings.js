  ...
  return (
    <Layout>
      <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto" data-testid="settings-page">
        ...
        {/* Success Message */}
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6 animate-fade-in" data-testid="success-message">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900">Physical Health</h2>
                    <p className="text-sm text-gray-600">Track your physical wellness</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <Scale className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <Ruler className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                    </div>
                  </div>
                </div>
                ...
                {bmi && (
                  <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-gray-700">Body Mass Index (BMI)</p>
                        <p className="text-xs text-gray-500 mt-1">Calculated from your weight and height</p>
                      </div>
                      <div className="text-right">
                        <p className="text-3xl font-bold text-blue-600">{bmi}</p>
                        <p className="text-sm text-gray-600 mt-1">{bmiCategory}</p>
                      </div>
                    </div>
                  </div>
                )}
          ...
          {activeTab === 'conditions' && (
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-2">Mental Health Conditions</h2>
                  ...
                  >
                    <div className="flex items-start flex-1">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-gray-900 text-lg">{condition.label}</p>
