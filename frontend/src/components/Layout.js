      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200 pt-5 pb-4 overflow-y-auto">
          ...
          <div className="px-2 pt-4 border-t border-gray-200 space-y-1">
            <Link
              to="/settings"
              className="w-full group flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-600 transition"
              data-testid="profile-button"
            >
              <User className="mr-3 h-5 w-5 text-gray-500 group-hover:text-purple-600" />
              Profile
            </Link>
            <button
